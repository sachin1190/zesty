...
class PropertyRepository {
  ...
  Future<DataOutput<PropertyModel>> fetchMostViewedPropertyNoAuth(
      {required int offset, required bool sendCityName}) async {
    ...
    if (sendCityName) {
      if (HiveUtils.getCityName() != null) {
        if (!Constant.isDemoModeOn) {
          queryParameters['city'] = HiveUtils.getCityName();
        }
      }
    }

    Map<String, dynamic> response = await Api.get(url: Api.apiGetProprtyNoAuth, queryParameters: queryParameters);
