...
import 'package:zestyrentals/data/model/user_type.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  void signInWithGoogle() async {
    ...
    if(googleSignInAccount != null) {
      ...
      context.read<LoginCubit>().login(
          userTypeId: selectedUser!.id,
          email: googleSignInAccount.email,
          phoneNumber: "",
          loginType: 2,
          fireabseUserId: authResult.user!.uid,
          countryCode: "+1");
    }
  ...
  List<UserType> userTypes = [
    UserType(id: 2, type: 'Agent'),
    UserType(id: 3, type: 'Landlord'),
  ];
  UserType? selectedUser = UserType(id: 2, type: 'Agent');
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: DropdownButton(
                ...
                items: userTypes.map((UserType items) {
