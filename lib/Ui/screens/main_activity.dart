...
class MainActivityState extends State<MainActivity>
  ...
  static late PageController pageCntrlr;
  ...
  void initState() {
    super.initState();
    HiveUtils.setUserIsNotNewWithoutAuth();
...
//This will init page controller
  ...
  AuthenticationState checkIsUserAuthenticated() {
   return context.read<AuthenticationCubit>().state;

  }

  void completeProfileCheck() async {

    if (checkIsUserAuthenticated() == AuthenticationState.authenticated) {
