...
import 'package:zestyrentals/Ui/screens/chat/chat_screen.dart';
import 'package:zestyrentals/Ui/screens/proprties/Property%20tab/sell_rent_screen.dart';
import 'package:zestyrentals/data/cubits/auth/auth_state_cubit.dart';
import 'package:zestyrentals/data/cubits/chatCubits/load_chat_messages.dart';
import 'package:zestyrentals/data/cubits/property/update_property_status.dart';
import 'package:zestyrentals/utils/string_extenstion.dart';
import 'package:flutter_svg/svg.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:url_launcher/url_launcher.dart' as urllauncher;

import 'package:zestyrentals/Ui/screens/widgets/blurred_dialoge_box.dart';
import 'package:zestyrentals/Ui/screens/widgets/like_button_widget.dart';
import 'package:zestyrentals/Ui/screens/widgets/read_more_text.dart';
import 'package:zestyrentals/app/routes.dart';
import 'package:zestyrentals/data/cubits/enquiry/send_enquiry_cubit.dart';
import 'package:zestyrentals/data/cubits/enquiry/store_enqury_id.dart';
import 'package:zestyrentals/data/cubits/favorite/add_to_favorite_cubit.dart';
import 'package:zestyrentals/data/cubits/property/Interest/change_interest_in_property_cubit.dart';
import 'package:zestyrentals/data/cubits/property/delete_property_cubit.dart';
import 'package:zestyrentals/Ui/screens/widgets/panaroma_image_view.dart';
import 'package:zestyrentals/data/cubits/property/fetch_my_properties_cubit.dart';
import 'package:zestyrentals/data/cubits/property/set_property_view_cubit.dart';
import 'package:zestyrentals/utils/AppIcon.dart';
import 'package:zestyrentals/utils/Extensions/extensions.dart';
...
import 'package:zestyrentals/utils/responsiveSize.dart';
      ...
      child: AnnotatedRegion(
        ...
        child: SafeArea(
          ...
          floatingActionButton: (property == null ||
              ...
              : Container(),
          bottomNavigationBar: (isPlayingYoutubeVideo == false && (context.read<AuthenticationCubit>().state == AuthenticationState.authenticated))
              ? BottomAppBar(
                            ...
                            children: <Widget>[
                              ...
                              Wrap(
                                ...
                                children: List.generate(
                                  ...
                                  print("PARAM ${property!.parameters!.elementAt(index).toMap()}");
                              ...
                              if ((int.parse(HiveUtils.getUserId() ?? "0") !=
                                  property?.addedBy) && (context.read<AuthenticationCubit>().state == AuthenticationState.authenticated))
                                Row(
                                  children: [
