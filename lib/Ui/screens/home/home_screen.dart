      ...
      child: RefreshIndicator(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leading: Padding(
              padding: EdgeInsetsDirectional.only(start: 20.rw(context)),
          ...
          body: Builder(builder: (context) {
            if (HiveUtils.isUserAuthenticated() && (hasCategoryError ||
                ...
                return SingleChildScrollView(
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          if (HiveUtils.isUserAuthenticated()) categoryWidget(),

                          if (!isPromotedPropertyEmpty && HiveUtils.isUserAuthenticated())
                            buildTitleHeader(
